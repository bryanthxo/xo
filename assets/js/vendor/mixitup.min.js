...
!function(t) {
    ...
    e.registerJqPlugin = function(t) {
        t.fn.mixItUp = function() {
            ...
            return o = this.each(function() {
                var o = null
                  , r = null;
                t && "string" == typeof t ? (o = e.instances[this.id],
                r = o[t].apply(o, a),
                "undefined" != typeof r && null !== r && "function" != typeof r.then && i.push(r)) : e(this, n)
            }),
    ...
    n.extend(e.Control.prototype, {
        ...
        handleClick: function(t) {
            ...
            this.pending = 0,
            i = a.selector ? n.closestParent(t.target, a.selector, !0, a.bound[0].dom.document) : a.el,
            !i)
    ...
    n.extend(e.Mixer.prototype, {
        ...
        attach: function(a, i, o, r) {
            ...
            s.config.load.dataset && (s.config.controls.enable = !1),
            s.indexTargets(),
            ...
            for (l = 0; n = e.controlDefinitions[l]; l++)
                if (t.config.controls.live || n.live) {
                    if (n.parent) {
                        ...
                        r = o;
                    s = t.getControl(r, n.type, n.selector),
                    t.controls.push(s)
                } else
                    for (a = o.querySelectorAll(n.selector),
                    c = 0; i = a[c]; c++)
        ...
        evaluateHideShow: function(t, e, n, a) {
            ...
            t === !0 && "show" === n || t === !1 && "hide" === n ? (a.show.push(e),
        ...
        goMix: function(a, i) {
            ...
            (o.config.animation.animateResizeContainer || i.startHeight === i.newHeight) && (o.dom.parent.style.height = i.startHeight + "px"),
            (o.config.animation.animateResizeContainer || i.startWidth === i.newWidth) && (o.dom.parent.style.width = i.startWidth + "px"),
        ...
        setInter: function(t) {
            ...
            e.config.animation.clampHeight && (e.dom.parent.style.height = t.startHeight,
        ...
        setFinal: function(t) {
            ...
            e.config.animation.clampHeight && (e.dom.parent.style.height = e.dom.parent.style.overflow = ""),
        ...
        getFinalMixData: function(e) {
            var a = this
              ...
              , r = null
              , s = -1;
            for (a.incPadding || (i = t.getComputedStyle(a.dom.parent)),
        ...
        cleanUp: function(t) {
            ...
            a.dom.parent.style[e.features.transitionProp] = a.dom.parent.style.height = a.dom.parent.style.width = a.dom.parent.style[e.features.perspectiveProp] = a.dom.parent.style[e.features.perspectiveOriginProp] = "",
        ...
        diffDatasets: function(t) {
            ...
            d = 0; r = t.newDataset[d]; d++) {
                ...
                f[h] = !0,
                (s = a.cache[h])instanceof e.Target ? (a.config.data.dirtyCheck && !n.deepEquals(r, s.data) && (l = a.renderTarget(r),
                s.data = r,
                a.dom.parent.replaceChild(l, s.dom.el),
                s.dom.el = l),
                l = s.dom.el) : (l = l = a.renderTarget(r),
                s = new e.Target,
                s.init(l, a, r)),
                s.isInDom ? (u = s.dom.el.nextElementSibling,
                o.push(h),
                c && (c.lastElementChild && c.appendChild(a.dom.document.createTextNode(" ")),
                a.dom.parent.insertBefore(c, s.dom.el),
                c = null)) : (c || (c = a.dom.document.createDocumentFragment()),
                c.lastElementChild && c.appendChild(a.dom.document.createTextNode(" ")),
                c.appendChild(l),
                s.isInDom = !0,
                t.toShow.push(s)),
                t.show.push(s)
            }
            for (c && (u = u || a.config.layout.siblingAfter,
            u && c.appendChild(a.dom.document.createTextNode(" ")),
            a.dom.parent.insertBefore(c, u)),
            d = 0; r = t.startDataset[d]; d++)
                h = r[a.config.data.uidKey],
                s = a.cache[h],
                t.show.indexOf(s) < 0 ? (t.hide.push(s),
                t.toHide.push(s),
                t.toRemove.push(s)) : i.push(h);
        ...
        renderTarget: function(t) {
            var n = this
              ...
              , r = "";
            if (n.callActions("beforeRenderTarget", arguments),
            "function" != typeof (a = n.config.render.target))
                throw new TypeError(e.messages.errorDatasetRendererNotSet());
            return r = a(t),
            o.innerHTML = r,
            i = o.firstElementChild,
            n.callFilters("elRenderTarget", i, arguments)
        },
        willSort: function(t, e) {
            var n = this
              , a = !1;
            return a = !!("random" === t.order || t.attribute !== e.attribute || t.order !== e.order || t.collection !== e.collection || null === t.next && e.next || t.next && null === e.next) || !(!t.next || !e.next) && n.willSort(t.next, e.next),
        ...
        getOperation: function(t) {
            ...
            a.filterOperation(c),
            r && (c.startContainerClassName = c.startState.activeContainerClassName,
    ...
    "object" == typeof exports && "object" == typeof module ? module.exports = e : "function" == typeof define && define.amd ? define(function() {
        return e
    }) : "undefined" != typeof t.mixitup && "function" == typeof t.mixitup || (t.mixitup = t.mixItUp = e),
    (a = t.$ || t.jQuery) && a.fn.jquery && e.registerJqPlugin(a),
    e.NAME = "mixitup",
    e.CORE_VERSION = "3.0.0"
}(window);
